...
function [ret_val] = getConfiguration(argType)
    if(argType == 1)
        ret_val = 'C:\Users\Kadir\IdeaProjects\VehicularEdgeCloudSim\sim_results';
    elseif(argType == 2)
    ...
    elseif(argType == 7)
        ret_val = {'RANDOM','VISIT_COUNT_BASED','TIME_BASED','UTILIZATION_BASED'};
    elseif(argType == 8)
        ret_val = {'random','visitCountBased','timeBased','utilizationBased'};
    elseif(argType == 9)
